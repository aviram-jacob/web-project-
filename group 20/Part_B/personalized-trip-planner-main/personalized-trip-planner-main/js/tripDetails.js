    ...
    '<div class="trip-details-layout">' +
      '<div class="trip-main">' +
        ...
        '<section class="detail-section">' +
          ...
          '<p>Traveler reviews help future visitors understand what to expect from this trip.</p>' +
...
function showTripNotFound() {
  ...
  if (hero) {
    hero.innerHTML =
      ...
      '<p class="lead-text">The selected trip could not be found in the available trip packages.</p>';
  }
  ...
  if (content) {
    content.innerHTML =
      '<div class="empty-state large-empty-state">' +
        ...
        '<p>Return to the recommendations page and choose one of the available trip packages.</p>' +
