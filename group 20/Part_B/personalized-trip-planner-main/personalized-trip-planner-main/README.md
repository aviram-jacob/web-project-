...
- Recommendations page renders 20 local trip packages from `js/data.js`.
...
4. Confirm Recommendations opens and cards render.
...
10. Save a trip from Recommendations or Trip Details.
11. Open My Trips and confirm the saved trip appears.
12. Remove a saved trip.
13. Log out and confirm guest behavior returns.
